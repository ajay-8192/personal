...
const Intro = () => {
    return (
        <section id="home" className="max-w-screen-2xl w-full mx-auto flex flex-col md:flex-row backdrop-blur-lg saturate-100 justify-between text-2xl items-center md:py-12 md:px-16 xl:px-32">
            ...
            <Image src={"/ajay.jpg"} alt="Ajay Chowdary" fetchPriority="high" title="Ajay Chowdary" quality={30} width={512} height={512} className="w-full md:w-2/5 md:p-0 aspect-square object-center object-cover md:rounded-lg" />
        </section>
    )
};
